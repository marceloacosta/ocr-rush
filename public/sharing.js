...
export function openResultShare({result,best,campaign=false,modal}){
 ...
 (async()=>{
  ...
  finally{if(native&&canvas.isConnected){native.textContent=shareImage?'Share image and link…':'Share link…';native.disabled=false;}}
 })();
}
